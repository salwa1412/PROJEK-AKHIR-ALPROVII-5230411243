...
conn.execute("INSERT INTO HEWAN (nama_hewan, jenis, asal, jml_skrng, thn_ditemukan) VALUES ('Harimau Sumatera', 'Mamalia', 'Sumatera', 400, 2020)")
...
conn.execute("INSERT INTO HEWAN (nama_hewan, jenis, asal, jml_skrng, thn_ditemukan) VALUES ('Burung Cendrawasih', 'Burung', 'Papua', 845, 2021)")
conn.execute("INSERT INTO HEWAN (nama_hewan, jenis, asal, jml_skrng, thn_ditemukan) VALUES ('Penyu Hijau', 'Reptil', 'NTT', 20, 2022)")
